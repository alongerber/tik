// Serverless API endpoint for Claude API calls
// This file is for Vercel/Netlify serverless functions
...
export default async function handler(req, res) {
  ...
  try {
    ...
    if (type === 'document') {
      // Vision request for document analysis
      messages = [
        {
          role: 'user',
          content: [
      ...
      // Proposal generation with form data
      messages = [
        {
          role: 'user',
